...
PACKAGE_PATH="$PROJECT_PATH/repos/meta-platform-ecosystem-core-repository/Main.Module/Application.layer/ecosystem-instance-manager.app"
STARTUP_JSON="$ECOSYSTEM_DATA_PATH/config-files/PlatformMainApplication.startup-params.json"
