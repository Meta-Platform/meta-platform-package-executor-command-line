...
PACKAGE_PATH="$PROJECT_PATH/repos/ecosystem-core-repository/Main.Module/Application.layer/repository-explorer.cli"
STARTUP_JSON="$PROJECT_PATH/repos/ecosystem-core-repository/Main.Module/Application.layer/repository-explorer.cli/metadata/startup-params.json"
